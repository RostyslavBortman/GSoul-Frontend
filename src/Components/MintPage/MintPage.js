...
export default function LoginPage() {
  ...
  const registred = async () => {
    axios
      .get(
        "https://gsoul-app.herokuapp.com/api/kyc/getUserByAddress/0x3A0060f7e429e6a8c217B8229d232E8Da506aa5434dd"
      )
      ...
      <div className="mintPage">
        <header className="mintPage-header">
          <div className="mintPage-wrapper">
            ...
            <a className="mintPage-link-err" href="#" onClick={navigate("/")}>
